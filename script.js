const showAction = document.getElementById("showAction");
...
function ponerVerbo(){
  ...
  let imgText = "<img src='Imagenes/"+verbs[randomPosition]+".jpg' height:'140px' width='100px'>";
  ...
  if (position >= 0){
    ...
    showAction.innerHTML = verbs[randomPosition];
